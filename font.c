...
const uint8_t gFontSmall[95][7] =
{
	...
	{0x00, 0x00, 0x08, 0x08, 0x08, 0x08, 0x00},    // '-'0
	{0x00, 0x00, 0x00, 0x60, 0x60, 0x00, 0x00},    // '.'0
	{0x00, 0x40, 0x20, 0x10, 0x08, 0x04, 0x02},    // '/'0
